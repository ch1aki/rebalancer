...
func init() {
	...
	utilruntime.Must(rebalancerv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e7eaa5de.ch1aki.github.io",
	...
	if err = (&rebalancerv1.Rebalance{}).SetupWebhookWithManager(mgr); err != nil {
